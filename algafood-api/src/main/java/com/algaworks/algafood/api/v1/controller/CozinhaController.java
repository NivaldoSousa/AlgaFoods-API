...
public class CozinhaController implements CozinhaControllerOpenApi {
    ...
    * */
    @CheckSecurity.Cozinhas.PodeConsultar // Antação que encapsula a anotação @PreAuthorize("isAuthenticated()")
    @GetMapping
    ...
    @CheckSecurity.Cozinhas.PodeEditar // Antação que encapsula a anotação @PreAuthorize("hasAuthority('EDITAR_COZINHAS')")
    @PostMapping
