...
/*
* Classe responsável por ativar a deserialização no formato Hal em MediaType customizado, pois quando temos MediaType customizado
* a deserialização do objeto não é feita em formato Hal.
* */
