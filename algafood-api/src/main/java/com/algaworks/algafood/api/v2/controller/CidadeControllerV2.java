...
@RestController
@RequestMapping(path = "/cidades", produces = AlgaMediaTypes.V2_APPLICATION_JASON_VALUE) // no produces estamos customizado o MediaType para o versionamento desse controlado
